...
{
public:
    HelloTriangleApplication() : window(WIDTH, HEIGHT, "Vulkan")
    {
    }
...
private:
...
#ifndef NDEBUG
        Debugger::getInstance().setupDebugMessenger();
#endif
    ...
    int rateDeviceSuitability(VkPhysicalDevice device)
    {
        ...
        std::cout << "Has graphics support: " << std::boolalpha << indices.graphicsFamily.has_value() << std::endl;
        std::cout << "Has geometryShader support: " << std::boolalpha << (bool)deviceFeatures.geometryShader << std::endl;
        std::cout << "DeviceType: ";
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device)
    {
        ...
        //     if (queueFamily.queueFlags & VK_QUEUE_GRAPHICS_BIT) {std::cout << "VK_QUEUE_GRAPHICS_BIT, ";}
        //     if (queueFamily.queueFlags & VK_QUEUE_COMPUTE_BIT) {std::cout << "VK_QUEUE_COMPUTE_BIT, ";}
        //     if (queueFamily.queueFlags & VK_QUEUE_TRANSFER_BIT) {std::cout << "VK_QUEUE_TRANSFER_BIT, ";}
        //     if (queueFamily.queueFlags & VK_QUEUE_SPARSE_BINDING_BIT) {std::cout << "VK_QUEUE_SPARSE_BINDING_BIT, ";}
        //     if (queueFamily.queueFlags & VK_QUEUE_PROTECTED_BIT) {std::cout << "VK_QUEUE_PROTECTED_BIT, ";}
        //     std::cout << std::endl;
        // }
    ...
    VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats)
    {
        for (const auto &availableFormat : availableFormats)
        {
            ...
            {
                std::cout << "Found perfect SurfaceFormat" << std::endl;
                return availableFormat;
            }
        }

        std::cout << "Settling for first SurfaceFormat" << std::endl;
    ...
    void cleanup()
    {
        ...
        VulkanInstance::getInstance().destroy();
